...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2011, 4, 10), new DateTime(2011, 5, 15), 500);
            var remainingFlight = new Flight(new DateTime(2011, 2, 1), new DateTime(2011, 5, 20), 1500);
            ...
            Assert.AreEqual(1, ServiceLocator.Instance.AvailableFlights);
